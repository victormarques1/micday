...
export function protegeRotaFisioterapeuta(req: Request, res: Response, next: NextFunction){
...
export function protegeRotaPaciente(req: Request, res: Response, next: NextFunction){
